...
object MobModelCatalog {
	...
	private val localTypesById: Map<String, EntityType<*>> = linkedMapOf(
		...
		"minecraft:camel_husk" to EntityType.CAMEL_HUSK,
		...
		"minecraft:nautilus" to EntityType.NAUTILUS,
		"minecraft:ocelot" to EntityType.OCELOT,
		"minecraft:panda" to EntityType.PANDA,
		"minecraft:parched" to EntityType.PARCHED,
		...
		"minecraft:zombie_nautilus" to EntityType.ZOMBIE_NAUTILUS,
